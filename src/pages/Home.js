        ...
        <View style={styles.contentSection}>
          ...
          <View style={styles.listHeader}>
            <View style={styles.listTitle}>
              ...
              <Text style={styles.listTitleText}>推薦房源</Text>
            </View>
            <Text style={styles.listCount}>共 {filteredListings.length} 間</Text>
          </View>
          ...
          {filteredListings.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateTitle}>沒有找到符合條件的房源</Text>
              <Text style={styles.emptyStateSubtitle}>試試調整搜尋條件或篩選器</Text>
            </View>
          ) : (
